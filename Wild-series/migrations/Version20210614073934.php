 ...
 */
final class Version20210614073934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actor_program DROP FOREIGN KEY actor_program_ibfk_1');
        $this->addSql('ALTER TABLE actor_program DROP FOREIGN KEY actor_program_ibfk_2');
        ...
        $this->addSql('ALTER TABLE actor_program RENAME INDEX program_id TO IDX_B01827EE3EB8070A');
        ...
        $this->addSql('ALTER TABLE program ADD slug VARCHAR(255) NOT NULL, CHANGE summary summary VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actor_program ADD CONSTRAINT actor_program_ibfk_1 FOREIGN KEY (actor_id) REFERENCES actor (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE actor_program ADD CONSTRAINT actor_program_ibfk_2 FOREIGN KEY (program_id) REFERENCES program (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE actor_program RENAME INDEX idx_b01827ee3eb8070a TO program_id');
        $this->addSql('ALTER TABLE episode DROP slug');
        $this->addSql('ALTER TABLE program MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE program DROP FOREIGN KEY FK_92ED778412469DE2');
        $this->addSql('ALTER TABLE program DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE program DROP slug, CHANGE summary summary TEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`');
